...
public class Stop implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText = "Dactivating all actions";
        MessageBean msg = new MessageBean();
		msg.setAction("STOPALL");
		...
		return input.getResponseBuilder().withSpeech(speechText).withSimpleCard("Stop", speechText).build();
    }
}
